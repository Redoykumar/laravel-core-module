	...
	*/
		 ...
		 */
            ...
            \Illuminate\Validation\ValidationException::class => [
                ...
                'pri'     => -100,
                'config'  => [
                    'api_code'  => ApiCodes::UNPROCESSABLE_ENTITY,
            ...
            \Symfony\Component\HttpKernel\Exception\NotFoundHttpException::class => [
                ...
                'pri'     => -100,
                'config'  => [
                    'api_code'  => ApiCodes::NOT_FOUND,
                    'http_code' => HttpResponse::HTTP_NOT_FOUND,
                ],
            ],
            Spatie\QueryBuilder\Exceptions\InvalidFieldQuery::class => [
                'handler' => \MarcinOrlowski\ResponseBuilder\ExceptionHandlers\DefaultExceptionHandler::class,
                'pri'     => -100,
                'config'  => [
                    'api_code'  => ApiCodes::BAD_REQUEST,
                    'http_code' => HttpResponse::HTTP_BAD_REQUEST,
                    'msg_key' => "Field 'invalid_field' is not allowed for filtering.",
                    'msg_enforce' => true
                ],
            ],
            Spatie\QueryBuilder\Exceptions\InvalidSortQuery::class => [
                'handler' => \MarcinOrlowski\ResponseBuilder\ExceptionHandlers\DefaultExceptionHandler::class,
                'pri'     => -100,
                'config'  => [
                    'api_code'  => ApiCodes::BAD_REQUEST,
                    'http_code' => HttpResponse::HTTP_BAD_REQUEST,
                    'msg_key' => "The sort field you requested is invalid. Please check the available fields for sorting.",
                    'msg_enforce' => true
                ],
            ],
            ...
            \Symfony\Component\HttpKernel\Exception\HttpException::class => [
                ...
                'pri' => -100,
                'config' => [
                    // Maintenance mode (Service Unavailable)
                    HttpResponse::HTTP_SERVICE_UNAVAILABLE => [
                        'api_code' => ApiCodes::SERVICE_UNAVAILABLE,
                        'http_code' => HttpResponse::HTTP_SERVICE_UNAVAILABLE,
                        'msg_key' => "The system is currently under maintenance. Please try again later.",
                        'msg_enforce' => true
                    ],
                    ...
                    HttpResponse::HTTP_INTERNAL_SERVER_ERROR => [
                        'api_code' => ApiCodes::INTERNAL_SERVER_ERROR,
                        'http_code' => HttpResponse::HTTP_INTERNAL_SERVER_ERROR,
                    ],
                    // Default handler (MUST be present)
                    'default' => [
                        'api_code' => ApiCodes::BAD_GATEWAY,
                        'http_code' => HttpResponse::HTTP_BAD_REQUEST, // 400 Bad Request
                    ],
                ],
            ],
